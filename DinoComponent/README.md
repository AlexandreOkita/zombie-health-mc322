...
Métodos | `public String getSintoma()` `public String getDoenca()` `public String setSintoma()` `public String setDoenca()`
Atributos | `private String sintoma` `private String doenca`
